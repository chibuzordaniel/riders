          ...
          <div className='  '>
            <nav className=' bg-white h-20  w-screen z-10  top-0 fixed drop-shadow-lg dark:bg-[#151D3B]'>
                ...
                <div className=' max-w-[1240px] mx-auto '>
                    <div className=' flex  justify-between'>
                        ...
                        <ul className=' flex'>
                            <div className='hidden md:flex py-6 gap-[53px] dark:text-[#FAF9F8]'>
                        ...
                        <div  className=' md:hidden sm:py-6 mr-9 ' onClick={handleClick}>
                              { !nav ? <IoAppsSharp className=' lg:w-7 lg:h-6  sm:w-5 sm:h-6 mt-1 dark:text-[#FAF9F8]'/> : <IoAppsSharp className=' w-7 h-6 mt-1 dark:text-[#FAF9F8]'/>  }
                        </div>
                   </div>
                   <ul className={!nav ? 'hidden' :  ' border-t-2 absolute  right-4 top-20  pt-4 pl-5 bg-white h-[200px] w-40  gap-[53px] dark:bg-[#17234f] shadow-xl dark:text-[#FAF9F8] '}>
                            ...
                            <li className=' flex gap-3 pt-2'><IoAppsSharp className=' mt-1' /><Link to='/About'>About</Link> </li>
                            <li className=' flex gap-3 pt-2'><IoAppsSharp className=' mt-1' /><Link to='/Project'>#Project</Link></li>
                            <li className=' flex gap-3 pt-2'><IoAppsSharp className=' mt-1' />Resume</li>
                            <li className=' flex gap-3 pt-2'><IoAppsSharp className=' mt-1' />Contact</li>
                  </ul>
                </div>
            </nav>
            <main className=" dark:bg-[#151D3B] ">
                ...
                <div className=' text-center relative bottom-20  '>
                    ...
                    <h1 className=" lg:text-7xl pt-5 dark:text-[#FAF9F8] font-Metamorphous sm:text-5xl ">I’m Christian Chibuzor</h1>
