    ...
    return(
        ...
        <section >
          <div className=' '>
           ...
           {/* section2/ Cov19Strain Application */}
              ...
              <div className=' max-w-[1240px] mx-auto  '>
                <div className=' lg:flex lg:gap-7 mt-40 sm:block'>
                        ...
                        <div className=' '>
                           ...
                           <div className=' pt-[54px]'>
                             <button className='bg-[#FF6B6B] lg:w-[100px] lg:h-[100px] lg:ml-0 rounded-full text-white  sm:w-[70px]  sm:h-[70px] sm:ml-7'> <a href="https://chibuzordaniel.github.io/worldenlens1/">View</a> </button>
                           </div>
                        </div>
                </div>
                </div>
